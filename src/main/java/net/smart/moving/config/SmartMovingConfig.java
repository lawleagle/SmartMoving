...
public class SmartMovingConfig extends SmartMovingProperties
{
	...
	public final Property<Float> _runFactorLevitate = PositiveFactor("move.run.factor.levitate").defaults(Value(1.3F).c(2.0F)).min(1.1F).comment("Standard sprinting factor while levitating (>= 1.1)");
